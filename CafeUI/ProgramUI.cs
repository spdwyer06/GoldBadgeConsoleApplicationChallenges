...
namespace CafeUI
{
    class ProgramUI
    {
        ...
        public void DeleteMenuItem()
        {
            ...
            MenuItem foundItem = menu.GetMenuItemByName(deleteItem);
            menu.RemoveMenuItem(foundItem);
        ...
        public void SeedMenu()
        {
            ...
            menu.AddNewMenuItem(doubleCheeseburger);
            ...
            menu.AddNewMenuItem(beefNCheddar);
            ...
            menu.AddNewMenuItem(buffaloChicken);
        }
    }
}
